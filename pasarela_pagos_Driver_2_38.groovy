job("Pasarela_pagos") {
  ...
  parameters {
        ...
        choiceParam('ETIQUETA', ['', '@CasoFeliz', '@Pasarela', '@Recargas', '@Paquetes', '@MiCuenta'],'Se ejecutará solo la etiqueta seleccionada, por defecto se ejecutaran todas las pruebas')
