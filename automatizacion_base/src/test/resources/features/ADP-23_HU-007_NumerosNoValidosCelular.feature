...
Feature: HU007 Validación número Invalido Celular
  ...
  Scenario Outline: Ingreso de números de menos de 10 dígitos
    Given estoy en la página de inicio de pago de facturas "https://transaccionesco-uat.tigocloud.net/servicios/facturas"
    When Cuando doy clic en el campo "Tu línea Tigo" y escribo el número celular <msisdn>
    Then botón "Consultar" se deshabilita y muestra el siguiente mensaje en color rojo "El número de línea que ingresaste no es válido."
  ...
  Scenario Outline: Ingreso de números que no comiencen con 3 ni con 5
    Given estoy en la página de inicio de pago de facturas "https://transaccionesco-uat.tigocloud.net/servicios/facturas"
    When Cuando doy clic en el campo "Tu línea Tigo" y escribo el número celular <msisdn>
    Then botón "Consultar" se deshabilita y muestra el siguiente mensaje en color rojo "El número de línea que ingresaste no es de Tigo. Verifícalo e intenta de nuevo."
