...
Feature: HU020_Cambio contraseña Wifi
  ...
  Scenario Outline: Mi Cuenta - Cambio contraseña wifi fallido
    ...
    Examples: 
      ...
      | "Mas de 13 Caracteres"            | "12345678901234" | "La contraseña es inválida, revise que tenga entre 8 y 13 caracteres."     |
      | "Contraseña exitosa Alfanumerica" | "Pruebas123#@"   | "El cambio de contraseña de la red de wifi fue exitoso."                   |
