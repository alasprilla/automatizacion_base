...
Feature: HU006_CambioDePlanMenuResumen
  ...
  Scenario: Mi Cuenta - Cámbiate ya en Resumen de línea móvil con plan 5.1
    ...
    And se quiere visualizar con resolucion "1023" x "700"
    ...
    And doy clic en "Seleccion MSISDN Jenkins"
    And doy clic en "Linea Pruebas Juanca Jenkins"
    #And selecciono "Hibrido - Pruebas (Juanca)" en el campo "Seleccion MSISDN Jenkins"
